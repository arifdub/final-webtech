...
?>
    ...
    <div class="col-xs-12 well">
       <div class="post-img col-xs-3">
           <a href="index.php?id=<?php echo $row['post_id']; ?>"><img class= "post-pic" src="img/<?php echo $row['post_pic']; ?>" width="100%" height="100%"></a>
         </div>
